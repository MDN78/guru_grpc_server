...
class PhotoCatalogService(photocatalog_pb2_grpc.PhotoCatalogServiceServicer):
    ...
    def Photo(self, request: photocatalog_pb2.IdRequest,
              context: ServicerContext) -> photocatalog_pb2.PhotoResponse:
        return photocatalog_pb2.PhotoResponse()

    def AddPhoto(self, request: photocatalog_pb2.PhotoRequest,
                 context: ServicerContext) -> photocatalog_pb2.PhotoResponse:
        return photocatalog_pb2.PhotoResponse()
